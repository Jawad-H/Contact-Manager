...
function Cards() {
    ...
    useEffect(() => {
        const getContacts = async () => {
            try {
                const res = await axios.get(`https://contact-appapi.herokuapp.com/api/contact/?username=${username}`);
    ...
    const handleDelete = async (id) => {
        try {
            const res = await axios.delete(`https://contact-appapi.herokuapp.com/api/contact/delete/${id}`);
    ...
    const saveFile = async (id) => {
        try {
            const res = await axios.get(`https://contact-appapi.herokuapp.com/api/contact/save/${id}`);
